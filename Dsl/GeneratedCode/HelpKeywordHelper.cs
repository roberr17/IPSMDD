...
namespace UPM_IPS.RDMDCM_ProyectoIPS
{
	...
	/// </remarks>
	public partial class RDMDCM_ProyectoIPSHelpKeywordHelper : RDMDCM_ProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new RDMDCM_ProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected RDMDCM_ProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the RDMDCM_ProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static RDMDCM_ProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class RDMDCM_ProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new RDMDCM_ProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected RDMDCM_ProyectoIPSHelpKeywordHelperBase()
			: base() { }
