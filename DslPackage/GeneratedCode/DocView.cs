...
namespace UPM_IPS.RDMDCM_ProyectoIPS
{
	...
	/// </summary>
	internal partial class RDMDCM_ProyectoIPSDocView : RDMDCM_ProyectoIPSDocViewBase
	{
		/// <summary>
		/// Constructs a new RDMDCM_ProyectoIPSDocView.
		/// </summary>
		public RDMDCM_ProyectoIPSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class RDMDCM_ProyectoIPSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new RDMDCM_ProyectoIPSDocView.
		/// </summary>
		protected RDMDCM_ProyectoIPSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			RDMDCM_ProyectoIPSDocDataBase docData = this.DocData as RDMDCM_ProyectoIPSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for RDMDCM_ProyectoIPSDocViewBase should be an RDMDCM_ProyectoIPSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.RDMDCM_ProyectoIPS.RDMDCM_ProyectoIPSDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.RDMDCM_ProyectoIPS.RDMDCM_ProyectoIPSDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.RDMDCM_ProyectoIPS.RDMDCM_ProyectoIPSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.RDMDCM_ProyectoIPS.RDMDCM_ProyectoIPSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.RDMDCM_ProyectoIPSDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.RDMDCM_ProyectoIPS.RDMDCM_ProyectoIPSHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.RDMDCM_ProyectoIPS.RDMDCM_ProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.RDMDCM_ProyectoIPS.RDMDCM_ProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
